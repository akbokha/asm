...
earchiveNewMachines <- earchive_correct[grepl("2E", earchive_correct$PN)|grepl("2P", earchive_correct$PN),]
...
Relative_Averages(DataFrameAbsolute = alldataNewMachines, DataFrameRelative = earchiveNewMachines, "Location")
